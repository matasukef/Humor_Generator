...
all_scores <- c(each_hl_mean_score, each_hh_mean_score)
all_humor_scores <- c(hl_humor_score[,1], hh_humor_score[,1])
all_img_sim <- c(hl_img_sim[,1], hh_img_sim[,1])
all_word_sim <- c(hl_word_sim[,1], hh_word_sim[,1])
...
sqh_low_group_scores_mean = SQH_low_group[6:8] / EXP_NUM
SQH_low_group_mean = cbind(SQH_low_group[1:5], sqh_low_group_scores_mean)
summary(SQH_low_group_mean[6:8])
boxplot(SQH_low_group_mean[6:8], main="SQH low group", names=c('baseline', 'HL caption', 'HH caption'), xlab="Captions", ylab="mean scores")

sqh_high_group_scores_mean = SQH_high_group[6:8] / EXP_NUM
SQH_high_group_mean = cbind(SQH_high_group[1:5], sqh_high_group_scores_mean)
summary(SQH_high_group_mean[6:8])
boxplot(SQH_high_group_mean[6:8], main="SQH high group", names=c('baseline',  'HL caption', 'HH caption'), xlab="Captions", ylab="mean scores")

MSHS_low_group_scores_mean = MSHS_low_group[6:8] / EXP_NUM
MSHS_low_group_mean = cbind(MSHS_low_group[1:5], MSHS_low_group_scores_mean)
summary(MSHS_low_group_mean[6:8])
boxplot(MSHS_low_group_mean[6:8], main="MSHS low group", names=c('baseline', 'HL caption', 'HH caption'), xlab="Captions", ylab="mean scores")

MSHS_high_group_scores_mean = MSHS_high_group[6:8] / EXP_NUM
MSHS_high_group_mean = cbind(MSHS_high_group[1:5], MSHS_high_group_scores_mean)
summary(MSHS_high_group_mean[6:8])
boxplot(MSHS_high_group_mean[6:8], main="MSHS high group", names=c('baseline', 'HL caption', 'HH caption'), xlab="Captions", ylab="mean scores")
...
SQH_high_and_MSHS_high_group_scores_mean = SQH_high_and_MSHS_high_group[6:8] / EXP_NUM
SQH_high_and_MSHS_high_group_mean = cbind(SQH_high_and_MSHS_high_group[1:5], SQH_high_and_MSHS_high_group_scores_mean)
summary(SQH_high_and_MSHS_high_group_mean[6:8])
boxplot(SQH_high_and_MSHS_high_group_mean[6:8], main="SQH high and SHSQ high group", names=c('baseline', 'HL caption', 'HH caption'), xlab="Captions", ylab="mean scores")
...
#boxplot
par(mfrow=c(1,1))
boxplot(high_img_sim_cap_scores_mean, names=c('baseline', 'HL caption', 'HH caption'), xlab="Captions", ylab="mean scores", ylim=c(1,4))
